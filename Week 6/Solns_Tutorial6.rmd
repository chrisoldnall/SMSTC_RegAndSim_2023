---
title: "Tutorial 6 - Generalised Linear Models (Solutions)."
...
Your Answer:
Within the data there are 8 variables, and 39 observations. There is a quarter character representing the time period the data comes from. Following this the Date period follows this along ranging from 0 to 38. Three categories Pandemic, JustPandemic and Pandemic_Cat which all relate to indicating the periods of the pandemic. We then have the number of referals and then the number of referals who started treatment within 31 days. Finally the population size is included.
...
```{r Exercise5}
model_1 <- glm(NumberOfEligibleReferrals31DayStandard ~ Date + Pandemic, data = ThirtyOneDays_Aggregated, family = family1)
summary(model_1)
```
